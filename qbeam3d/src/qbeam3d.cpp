...
QBeam3D::QBeam3D()
    : QMainWindow( 0, "QBeam3D", WDestructiveClose )
{
...
void QBeam3D::load( const QString &fileName )
{
    QFile f( fileName );
...
void QBeam3D::closeEvent( QCloseEvent* ce )
{
    if ( !e->isModified() ) {
	ce->accept();
	return;
